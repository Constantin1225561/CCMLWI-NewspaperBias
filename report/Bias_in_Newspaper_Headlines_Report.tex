...
% add classification 16 classes part
...
One of our first results was a general Sentiment Analysis. We use the VADER sentiment analysis framework \cite{VAD14} since it is has been shown to achieve good performance on short social media text. VADER is able to detect the polarity of complicated sentences with human-like accuracy. %TODO: explain how it works and how we used it etc.
...
%TODO: not forget interpretation for flavour
